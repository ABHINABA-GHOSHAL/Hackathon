        ...
        for subdir in dirs:
            ...
            for file in os.listdir(subdir_path):
                ...
                try:
                    ...
                    img = np.array(img)
                    if img.shape == (32, 32, 3):  # Ensure the image is in the correct shape
...
xgb_classifier.fit(train_images, train_labels)

# Evaluate the classifier
train_predictions = xgb_classifier.predict(train_images)
val_predictions = xgb_classifier.predict(val_images)
test_predictions = xgb_classifier.predict(test_images)
...
try:
    ...
    result = xgb_classifier.predict(test_image)
